...
/*
  ...
  OPTION 8 : Send the sensor data on the Processing interface with Bluetooth
*/
...
#define CALIBRATION_MAX 730 // When a finger is on the table, the value of the sensor area drop down between those 2 values
...
#define SENSOR_LE 20 // Latch pin of the CISs
#define SENSOR_CLK 21 // Clock pin os the CISs
#define STP_SDI 44
#define STP_CLK 45
#define STP_LE 46
...
#endif
#if OPTION == 8
    send_data_bluetooth(); // send data on the Processing interface for debugging
#endif
  }
...
void init_Pin() {
  ...
  pinMode(STP_SDI, OUTPUT);
  pinMode(STP_CLK, OUTPUT);
  pinMode(STP_LE, OUTPUT);
  pinMode(13, OUTPUT);
  digitalWrite(STP_LE, LOW);
  digitalWrite(STP_SDI, LOW);
...
char STP_config[4] = {0, 0, 0, 0};
  if (state == LOW) {
    switch (numled) {
      ...
      case 0: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x80; break;
      case 1: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x40; break;
      case 2: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x20; break;
      case 3: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x10; break;
      case 4: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x08; break;
      case 5: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x04; break;
      case 6: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x02; break;
      case 7: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x01; break;
      case 8: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x01; STP_config[3] = 0x00; break;
      case 9: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x02; STP_config[3] = 0x00; break;
      case 10: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x04; STP_config[3] = 0x00; break;
      case 11: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x08; STP_config[3] = 0x00; break;
      case 12: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x10; STP_config[3] = 0x00; break;
      case 13: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x20; STP_config[3] = 0x00; break;
      case 14: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x40; STP_config[3] = 0x00; break;
      case 15: STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x80; STP_config[3] = 0x00; break;

      case 16: STP_config[0] = 0x00; STP_config[1] = 0x80; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 17: STP_config[0] = 0x00; STP_config[1] = 0x40; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 18: STP_config[0] = 0x00; STP_config[1] = 0x20; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 19: STP_config[0] = 0x00; STP_config[1] = 0x10; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 20: STP_config[0] = 0x00; STP_config[1] = 0x08; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 21: STP_config[0] = 0x00; STP_config[1] = 0x04; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 22: STP_config[0] = 0x00; STP_config[1] = 0x02; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 23: STP_config[0] = 0x00; STP_config[1] = 0x01; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 24: STP_config[0] = 0x80; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 25: STP_config[0] = 0x40; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 26: STP_config[0] = 0x20; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 27: STP_config[0] = 0x10; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 28: STP_config[0] = 0x8; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 29: STP_config[0] = 0x04; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 30: STP_config[0] = 0x02; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;
      case 31: STP_config[0] = 0x01; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00; break;

    }
  }
  else {
    STP_config[0] = 0x00; STP_config[1] = 0x00; STP_config[2] = 0x00; STP_config[3] = 0x00;
  }
